...
import com.example.ellai.bokeh2.utils.SpacesItemDecoration;
...
/////////
        originalImage = getArguments().getParcelable("BitmapImage");
...
///////////
        ...
        prepareThumbnail(originalImage);//(null);
    ...
    public void prepareThumbnail(final Bitmap bitmap) {
        Runnable r = new Runnable() {
            public void run() {
                ...
                if (bitmap == null) {
                    thumbImage = BitmapUtils.getBitmapFromAssets(getActivity(), EditingActivity.IMAGE_NAME, 100, 100);
                } else {
